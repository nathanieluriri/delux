...
export function AboutSection() {
  return (
   <>
    <section className="p-3 mt-[130px] pt-22 md:pt-6 h-fit max-h-[550] max-w-[1600px] w-screen flex items-center justify-center  bg-cover bg-center bg-no-repeat"  style={{
