    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="mt-3.5 flex flex-row gap-10 items-center justify-around ">
          <a href="https://api.deluxplatform.ng/whatsApplink"> <div className="flex flex-col gap-5 items-center" ><FaWhatsapp size={30} color="#25D366" /><p className='text-black' >WhatsApp</p></div> </a>
          <a href="https://api.deluxplatform.ng/Telegramlink"> <div className="flex flex-col gap-5 items-center" > <FaTelegram size={30} color="#0088cc" /> <p className='text-black' >Telegram</p></div> </a>
        </div>
      </div>
    </div>
  );
