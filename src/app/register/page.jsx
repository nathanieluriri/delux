...
export default function registerPage(){
    ...
    return (
        <section className="flex justify-center bg-cover bg-no-repeat bg-black bg-center justify-items-center items-center justify-self-center w-screen h-screen" style={{
            ...
            <OverlayContent isOpen={isOpen} onClose={closeOverlay} />
              ...
              <button onClick={openOverlay} class="w-full p-3 bg-amber-400 hover:bg-amber-400/70 text-white font-bold rounded-lg">Register</button>
              </div>
